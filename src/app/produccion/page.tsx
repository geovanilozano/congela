  ...
  return (
    <div className="space-y-6">
      ...
      <form
        ...
        action={enEdicion ? actualizarProduccion : crearProduccion}
      ...
      >
        ...
        <label className="text-sm">
          ...
          <select name="turno" defaultValue={enEdicion?.turno ?? ""} className="mt-1 w-full rounded-lg border border-slate-300 px-2 py-1.5">
            <option value="">—</option>
        ...
        <label className="text-sm">
          ...
          <select name="tipo" defaultValue={enEdicion?.tipo ?? "cubo"} className="mt-1 w-full rounded-lg border border-slate-300 px-2 py-1.5">
        ...
        <label className="text-sm">
          ...
          <select name="empleadoId" defaultValue={enEdicion?.empleadoId ?? ""} className="mt-1 w-full rounded-lg border border-slate-300 px-2 py-1.5">
            <option value="">—</option>
        ...
        <label className="text-sm">
          ...
          <input name="bolsas" type="number" min="0" required defaultValue={enEdicion?.bolsas} className="mt-1 w-full rounded-lg border border-slate-300 px-2 py-1.5" />
        </label>
        <label className="text-sm">
          <span className="text-slate-500">Kilos (opcional)</span>
          <input name="kilos" type="number" min="0" step="0.1" defaultValue={enEdicion?.kilos ?? undefined} className="mt-1 w-full rounded-lg border border-slate-300 px-2 py-1.5" />
        </label>
        <label className="text-sm">
          <span className="text-slate-500">Pérdidas (bolsas)</span>
          <input name="perdidas" type="number" min="0" defaultValue={enEdicion?.perdidas ?? 0} className="mt-1 w-full rounded-lg border border-slate-300 px-2 py-1.5" />
        </label>
        <label className="text-sm">
              ...
              <tr key={r.id} className="border-t border-slate-100">
                ...
                <td className="pr-3 text-right">
                  <div className="flex items-center justify-end gap-3">
                    ...
                    <BotonEliminar action={eliminarProduccion} id={r.id} />
                  </div>
                </td>
              </tr>
            ))}
